...
const WRITE_VERB_SRC = "\\b(?:Set-Content|Add-Content|Out-File|New-Item|Remove-Item|Copy-Item|Move-Item|Rename-Item|Set-Item|Clear-Content|Clear-Item|Remove-ChildItem|Set-ItemProperty|New-ItemProperty|Remove-ItemProperty|mkdir|rmdir|md|rd|del|erase|ren|move|copy|xcopy|robocopy|ri|rm|ni|cp|cpi|mv|mi|rni|sp|si|sc|ac|clc|cli)\\b[\\s\\S]{0,160}"
